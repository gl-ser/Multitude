...
Диапазон изменения подаваемой на вход широты [-/2; +/2].

Диапазон изменения подаваемой на вход долготы может быть либо [0; +2), либо [ ; +].

Результат возвращается также в радианах, но долгота возвращается только в пределах [0; +2).
...
2. _APlusB_ к множеству A прибавляет несколько множеств B (AB)
...
3. _AIntersectionB_ возвращает пересечение множества A с хотя бы одним множеством из B (AB)
...
4. _AXorB_ объединяет множества A и B, затем из результата вычитает пересечение множества A с хотя бы одним множеством из B ((AB)\(AB))
